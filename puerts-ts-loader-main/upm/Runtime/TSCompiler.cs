...
namespace Puerts.TSLoader
{
    ...
    {
        public static string RuntimeDataPath = Application.dataPath + "/com.plume.typescript/puerts-ts-loader-main/upm/Javascripts~";
        ...
        public TSCompiler(string tsRootPath)
        {
            ...
            })")(tsRootPath, Path.GetFullPath(RuntimeDataPath));
